...
<body>
    ...
    <section class="parallax">
        ...
        <img src="img/truck.png" id="truck" alt="#"
            style="transform: scale(0.8); left: -60px; top: -125px" />
        <img src="img/Logo.png" id="logoswipe" alt="#" style="transform: scale(0.3)" />
    </section>
    <div class="content">
        <img class="triangle-bg-right" id="triangle-bg-right" src="img/SeekPng.com_triangle-png-tumblr_8630628.png"
            alt="#" />
        ...
        <div class="text">
            <h1>STOCK FM</h1>
            <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Necessitatibus perferendis dignissimos libero
                et eius fugit assumenda rerum accusantium nostrum consequuntur dolorem natus, excepturi ipsa laborum id
                fuga ipsam. Minus
                commodi deserunt quam quasi, tempora voluptatem dolorem consequuntur tenetur saepe repellendus aperiam
                accusamus nobis laboriosam? Hic quo sint nesciunt harum neque!
            </p>
            <button class="check">
    ...
    <div class="what-we-are">
        <div class="">
            <div class="">
                <p>
                    Necessitatibus perferendis dignissimos libero et eius fugit assumenda rerum accusantium
                </p>
                <span class="bar"></span>
                <h1>BEST QUALITY</h1>
            </div>
    ...
    <section class="feature">
        ...
        <div class="feature-page">
            <div class="feature-box">
                <lottie-player src="https://assets7.lottiefiles.com/packages/lf20_cz2x0yb7.json"
                    background="transparent" speed="1" style="width: 200px; height: 200px" loop autoplay>
                </lottie-player>
                <h5>Trusted Review</h5>
            </div>
            <div class="feature-box">
                <lottie-player src="https://assets7.lottiefiles.com/packages/lf20_vas19ssm.json"
                    background="transparent" speed="1" style="width: 200px; height: 200px" loop autoplay>
                </lottie-player>
                <h5>Guaranteed Price</h5>
            </div>
            <div class="feature-box">
                <lottie-player src="https://assets7.lottiefiles.com/packages/lf20_TXBESKCamC.json"
                    background="transparent" speed="1" style="width: 200px; height: 200px" loop autoplay>
                </lottie-player>
                <h5>Worldwide Shipment</h5>
            </div>
            <div class="feature-box">
                <lottie-player src="https://assets9.lottiefiles.com/packages/lf20_npdm92px.json"
                    background="transparent" speed="1" style="width: 200px; height: 200px" loop autoplay>
                </lottie-player>
                <h5>24/7 Support</h5>
            </div>
