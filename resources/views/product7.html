    ...
    <div class="container">
        <div class="card">
            <div class="itemBackground">
                ...
                <h1 class="nike">Batu</h1>
                <img src="img/logo.png" alt="" class="logo">
                <a href="#" class="share"><i class="fas fa-share-alt"></i></a>
                <img src="https://cdn.staticcrate.com/stock-hd/materials/materials-Cooled_Lava_Rock_4/1-xs.png" alt="" class="item show" color="blue">
                <img src="https://cdn.staticcrate.com/stock-hd/materials/materials-Cooled_Lava_Rock_3/1-xs.png" alt="" class="item" color="red">
                <img src="https://cdn.staticcrate.com/stock-hd/materials/materials-Cooled_Lava_Rock_2/1-xs.png" alt="" class="item" color="green">
                <img src="https://cdn.staticcrate.com/stock-hd/materials/materials-Cooled_Lava_Rock_1/1-xs.png" alt="" class="item" color="orange">
                <img src="img/black.png" alt="" class="item" color="black">
            </div>
            <div class="info">
                <div class="itemName">
                    <div>
                        <h1 class="big">Batu</h1>
                        <span class="new">new</span>
                    </div>
                    <h3 class="small">Batu Halus</h3>
                </div>
