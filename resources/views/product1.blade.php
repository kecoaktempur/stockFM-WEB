    ...
    <div class="container">
        <div class="card">
            <div class="itemBackground">
                ...
                <img src="img/cooled-lava-rock1-md.png" alt="" class="item show" color="blue">
                <img src="img/cooled-lava-rock2-md.png" alt="" class="item" color="red">
                <img src="img/cooled-lava-rock3-md.png" alt="" class="item" color="green">
                <img src="img/cooled-lava-rock4-md.png" alt="" class="item" color="orange">
