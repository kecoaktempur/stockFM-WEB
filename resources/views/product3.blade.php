    ...
    <div class="container">
        <div class="card">
            <div class="itemBackground">
                ...
                <h1 class="nike">Slate Rock</h1>
                <img src="img/logo.png" alt="" class="logo">
                <a href="#" class="share"><i class="fas fa-share-alt"></i></a>
                <img src="https://cdn.staticcrate.com/stock-hd/materials/materials-Slate_Ground_1/1-md.png" alt="" class="item show" color="blue">
                <img src="https://cdn.staticcrate.com/stock-hd/materials/materials-Slate_Ground_2/1-md.png" alt="" class="item" color="red">
                <img src="" alt="" class="item" color="green">
                <img src="" alt="" class="item" color="orange">
